...
class Product extends CActiveRecord
{
	...
	*/
	...
	{
		return url('product/view', array('id'=>$this->id));	
	}
	...
	*/
	...
	{
		return url('product/edit', array('id'=>$this->id));	
	}
	...
	*/
	...
	{
		return url('product/image', array('id'=>$this->id));	
	}
	...
	*/
	...
	public function rules()
	{
		...
		return array(
			array('name, timestamp, image', 'required'),
			array('name', 'unique'),
			array('description, image', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, description, timestamp, image', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'productsTags' => array(self::HAS_MANY, 'ProductsTags', 'product'),
		);
	}
